...
extern "C" void filament_Camera_nSetProjection(void *nativeCamera, int projection, float left, float right,
                                               float bottom, float top, float near, float far) {
    Camera *camera = (Camera *) nativeCamera;
    camera->setProjection((Camera::Projection) projection, left, right, bottom, top, near, far);
}

extern "C" void filament_Camera_nSetProjectionFov(void *nativeCamera, float fovInDegrees, float aspect,
                                                  float near, float far, int fov) {
    Camera *camera = (Camera *) nativeCamera;
    camera->setProjection(fovInDegrees, aspect, near, far, (Camera::Fov) fov);
}

extern "C" void filament_Camera_nSetLensProjection(void *nativeCamera, float focalLength, float aspect,
...
//extern "C" void filament_Camera_nSetScaling(void *nativeCamera, floatArray inScaling_) {
//    Camera *camera = (Camera *) nativeCamera;
...
extern "C" void filament_Camera_nLookAt(void *nativeCamera, float eye_x, float eye_y, float eye_z,
...
extern "C" float filament_Camera_nGetNear(void *nativeCamera) {
    Camera *camera = (Camera *) nativeCamera;
    return camera->getNear();
}

extern "C" float filament_Camera_nGetCullingFar(void *nativeCamera) {
    Camera *camera = (Camera *) nativeCamera;
    return camera->getCullingFar();
}

extern "C" void filament_Camera_nSetModelMatrix(void *nativeCamera, float *m) {
    Camera *camera = (Camera *) nativeCamera;
...
extern "C" void filament_Camera_nGetProjectionMatrix(void *nativeCamera, filament::math::mat4f *outMatrix) {
    Camera *camera = (Camera *) nativeCamera;
...
//}
//
extern "C" void filament_Camera_nGetModelMatrix(void *nativeCamera, filament::math::mat4f *outMatrix) {
    Camera *camera = (Camera *) nativeCamera;
    *outMatrix = filament::math::mat4f(camera->getModelMatrix());
}

//extern "C" void filament_Camera_nGetPosition(void *nativeCamera,
//                                             floatArray out_) {
//    Camera *camera = (Camera *) nativeCamera;
...
//}
//
//extern "C" void filament_Camera_nGetLeftVector(void *nativeCamera,
//                                               floatArray out_) {
//    Camera *camera = (Camera *) nativeCamera;
//    float *out = env->GetFloatArrayElements(out_, NULL);
...
//}
//
//extern "C" void filament_Camera_nGetUpVector(void *nativeCamera,
//                                             floatArray out_) {
//    Camera *camera = (Camera *) nativeCamera;
//    float *out = env->GetFloatArrayElements(out_, NULL);
...
//}
//
//extern "C" void filament_Camera_nGetForwardVector(void *nativeCamera, floatArray out_) {
//    Camera *camera = (Camera *) nativeCamera;
//    float *out = env->GetFloatArrayElements(out_, NULL);
...
extern "C" void filament_Camera_nSetExposure(void *nativeCamera,
...
extern "C" float filament_Camera_nGetAperture(void *nativeCamera) {
    Camera *camera = (Camera *) nativeCamera;
    return camera->getAperture();
}

extern "C" float filament_Camera_nGetShutterSpeed(void *nativeCamera) {
    Camera *camera = (Camera *) nativeCamera;
    return camera->getShutterSpeed();
}

extern "C" float filament_Camera_nGetSensitivity(void *nativeCamera) {
    Camera *camera = (Camera *) nativeCamera;
    return camera->getSensitivity();
}

extern "C" int filament_Camera_nGetEntity(void *nativeCamera) {
    Camera *camera = (Camera *) nativeCamera;
