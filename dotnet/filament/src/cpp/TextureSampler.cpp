...
extern "C" int filament_TextureSampler_nCreateSampler(int min, int max, int s, int t, int r) {
...
extern "C" int filament_TextureSampler_nCreateCompareSampler(int mode, int function) {
...
extern "C" int filament_TextureSampler_nGetMinFilter(int sampler_) {
    TextureSampler &sampler = reinterpret_cast<TextureSampler &>(sampler_);
    return static_cast<int>(sampler.getMinFilter());
}

extern "C" int filament_TextureSampler_nSetMinFilter(int sampler_, int filter) {
    TextureSampler &sampler = reinterpret_cast<TextureSampler &>(sampler_);
    sampler.setMinFilter(static_cast<TextureSampler::MinFilter>(filter));
    return sampler.getSamplerParams().u;
}

extern "C" int filament_TextureSampler_nGetMagFilter(int sampler_) {
    TextureSampler &sampler = reinterpret_cast<TextureSampler &>(sampler_);
    return static_cast<int>(sampler.getMagFilter());
}

extern "C" int filament_TextureSampler_nSetMagFilter(int sampler_, int filter) {
    TextureSampler &sampler = reinterpret_cast<TextureSampler &>(sampler_);
    sampler.setMagFilter(static_cast<TextureSampler::MagFilter>(filter));
    return sampler.getSamplerParams().u;
}

extern "C" int filament_TextureSampler_nGetWrapModeS(int sampler_) {
    TextureSampler &sampler = reinterpret_cast<TextureSampler &>(sampler_);
    return static_cast<int>(sampler.getWrapModeS());
}

extern "C" int filament_TextureSampler_nSetWrapModeS(int sampler_, int mode) {
    TextureSampler &sampler = reinterpret_cast<TextureSampler &>(sampler_);
    sampler.setWrapModeS(static_cast<TextureSampler::WrapMode>(mode));
    return sampler.getSamplerParams().u;
}

extern "C" int filament_TextureSampler_nGetWrapModeT(int sampler_) {
    TextureSampler &sampler = reinterpret_cast<TextureSampler &>(sampler_);
    return static_cast<int>(sampler.getWrapModeT());
}

extern "C" int filament_TextureSampler_nSetWrapModeT(int sampler_, int mode) {
    TextureSampler &sampler = reinterpret_cast<TextureSampler &>(sampler_);
    sampler.setWrapModeT(static_cast<TextureSampler::WrapMode>(mode));
    return sampler.getSamplerParams().u;
}

extern "C" int filament_TextureSampler_nGetWrapModeR(int sampler_) {
    TextureSampler &sampler = reinterpret_cast<TextureSampler &>(sampler_);
    return static_cast<int>(sampler.getWrapModeR());
}

extern "C" int filament_TextureSampler_nSetWrapModeR(int sampler_, int mode) {
    TextureSampler &sampler = reinterpret_cast<TextureSampler &>(sampler_);
    sampler.setWrapModeR(static_cast<TextureSampler::WrapMode>(mode));
    return sampler.getSamplerParams().u;
}

extern "C" int filament_TextureSampler_nGetCompareMode(int sampler_) {
    TextureSampler &sampler = reinterpret_cast<TextureSampler &>(sampler_);
    return static_cast<int>(sampler.getCompareMode());
}

extern "C" int filament_TextureSampler_nSetCompareMode(int sampler_, int mode) {
    TextureSampler &sampler = reinterpret_cast<TextureSampler &>(sampler_);
...
extern "C" int filament_TextureSampler_nGetCompareFunction(int sampler_) {
    TextureSampler &sampler = reinterpret_cast<TextureSampler &>(sampler_);
    return static_cast<int>(sampler.getCompareFunc());
}

extern "C" int filament_TextureSampler_nSetCompareFunction(int sampler_, int function) {
    TextureSampler &sampler = reinterpret_cast<TextureSampler &>(sampler_);
    sampler.setCompareMode(sampler.getCompareMode(), static_cast<TextureSampler::CompareFunc>(function));
    return sampler.getSamplerParams().u;
}

extern "C" float filament_TextureSampler_nGetAnisotropy(int sampler_) {
    TextureSampler &sampler = reinterpret_cast<TextureSampler &>(sampler_);
    return sampler.getAnisotropy();
}

extern "C" int filament_TextureSampler_nSetAnisotropy(int sampler_, float anisotropy) {
    TextureSampler &sampler = reinterpret_cast<TextureSampler &>(sampler_);
