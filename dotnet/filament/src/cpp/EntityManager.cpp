...
extern "C" void *filament_EntityManager_nGetEntityManager() {
    return (void *) &EntityManager::get();
}

// FIXME
//extern "C" void filament_EntityManager_nCreateArray(void * nativeEntityManager, int n, intArray entities_) {
...
extern "C" int filament_EntityManager_nCreate(void *nativeEntityManager) {
    EntityManager *em = (EntityManager *) nativeEntityManager;
...
extern "C" void filament_EntityManager_nDestroy(void *nativeEntityManager, int entity_) {
    EntityManager *em = (EntityManager *) nativeEntityManager;
    Entity &entity = *reinterpret_cast<Entity *>(&entity_);
    em->destroy(entity);
}

extern "C" bool filament_EntityManager_nIsAlive(void *nativeEntityManager, int entity_) {
    EntityManager *em = (EntityManager *) nativeEntityManager;
    Entity &entity = *reinterpret_cast<Entity *>(&entity_);
